...
- **Reactivate...** — re-bind your Google account after hardware changes, or after your license is invalidated
...
### Support & License Sales

- **Email:** [cdsync@dark.app.br](mailto:cdsync@dark.app.br) — for support, bug reports, and license purchases
- **Bug reports:** include `cdsync --version` and a snippet of `~/.cdsync/log/cdsync.log`
- **Updates:** the latest version is always at **[cdsync.dark.app.br](https://cdsync.dark.app.br)** — download it again and follow the same 4 steps.
